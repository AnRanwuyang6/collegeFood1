$(function() {
    ...
    $("#editBtn").click(function () {
        var id = $("#hiddenId").val();
        window.location.href = '/firstInstance/toEditExamine?id='+id;
    })
    ...
    $("#pass").click(function () {
        ...
        var url='/firstInstance/passManu?id='+id;
        if(manuSum!=undefined && manuSum!= null){
    ...
    $("#rebackSubmit").click(function () {
        ...
        window.location.href = '/firstInstance/revokeManu?id='+id+"&view="+view;
    })

    //预览
    $("#previewBtn").click(function () {
        var id = $("#hiddenId").val()
        window.open("/firstInstance/preview?id="+id,"_blank");
    })
