/**
 * Created by yangzy on 2018/1/24.
 */
(function(global, $, Crop) {
    ...
    function _createDom($wrap, opt) {
        ...
        var $form = $('<form enctype="multipart/form-data" action="' + opt.url + '" enctype="multipart/form-data" method="post" target="uploadIfr"/>');
        ...
        var $picker = $('<div class="crop-picker-wrap"></div>');

        var $fileInp = $('<input type="file" id="fileuploadImg" name="file" accept="' + accept + '" class="crop-picker-file">');
        $picker.append($fileInp);
        $form.append($cropDataInp).append($picker);
        $form.append($cropDataInp);
        ...
        var $cropContainer = $('<div class="crop-container"/>').append($cropArea);

        $cropWrap.append($cropContainer);
        // var $saveSource = $('<div class="crop-save">上传原图</div>');
        var $save = $('<button class="crop-save">上传</button>');
        var $cropCancel = $('<button class="crop-cancel">取消</button>');
        // var $save = $('<div class="ui primary button">保存</div>');
        // var $cropCancel = $('<div class="ui button">取消</div>');
